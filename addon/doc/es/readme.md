...
| `NVDA+Shift+S` | Capturar y describir pantalla completa |
| `NVDA+Shift+F` | Cargar imagen desde archivo |
...
- Intenta usar la captura de pantalla (`NVDA+Shift+S`) como alternativa
